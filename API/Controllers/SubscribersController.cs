...
namespace API.Controllers
{
    public class SubscribersController : ApiController
    {
        ...
        private readonly string SelectIdQuery = @"select id from subscribers where fullName = @FullName and dateSubscribed = @DateSubscribed and currency = @Currency and amount = @Amount";
        ...
        public IActionResult Create(SubscribersRequest requestData)
        {
            ...
            return Create(requestData, InsertQuery, SelectIdQuery, nameof(GetSub));
        }
